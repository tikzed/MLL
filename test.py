...
from scr.const import PATH_TEST_DIR, PATH_TEST_LABELS, WEIGHTS_PATH, PATH_TEST_RESULTS
from scr.config import MODEL, N_HEADS, ENC_LAYERS, DEC_LAYERS, CASE, PUNCT, \
...
from scr.utils import evaluate

...
from scr.const import DIR, PATH_TEST_DIR, PATH_TEST_LABELS, WEIGHTS_PATH, PREDICT_PATH
from scr.config import MODEL, ALPHABET, N_HEADS, ENC_LAYERS, DEC_LAYERS, DEVICE, HIDDEN

from scr.utils import generate_data, process_data
from scr.dataset import TextCollate, TextLoader
from scr.utils import prediction

char2idx = {char: idx for idx, char in enumerate(ALPHABET)}
idx2char = {idx: char for idx, char in enumerate(ALPHABET)}

if MODEL == 'model1':
  from scr.models import model1
